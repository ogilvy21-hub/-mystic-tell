    ...
    fortunes: [
        {
            ...
            career: '승진이나 이직의 기회가 많습니다. 새로운 프로젝트를 맡게 되거나 리더십을 발휘할 기회가 생깁니다.',
            love: '새로운 만남이나 기존 관계의 발전이 기대됩니다. 싱글인 경우 운명적인 만남이 기다리고 있습니다.',
            health: '전반적으로 활력이 넘치는 한 해입니다. 새로운 운동을 시작하기 좋은 시기입니다.',
            money: '투자나 부동산에서 좋은 결과를 얻을 수 있습니다. 재정 상황이 크게 개선될 것입니다.',
            advice: '기회가 왔을 때 주저하지 말고 도전하세요. 당신의 능력을 믿고 자신감을 가지세요.'
        },
        {
            name: '성장과 학습의 해',
            icon: '📚',
            summary: '새로운 지식과 기술을 습득하며 자신을 발전시키는 해입니다.',
            career: '전문성 향상을 위한 교육이나 자격증 취득이 도움됩니다. 해외 연수 기회가 생길 수 있습니다.',
            love: '지적인 대화를 나눌 수 있는 상대방과 좋은 인연이 됩니다. 함께 성장할 수 있는 관계가 발전할 것입니다.',
            health: '정신적 스트레스 관리가 중요합니다. 명상이나 요가 등 마음의 평정을 찾는 활동이 도움됩니다.',
            money: '교육비나 자기계발 투자를 아끼지 마세요. 장기적으로 큰 수익으로 돌아올 것입니다.',
            advice: '배움에 인색하지 마세요. 지금 투자한 시간과 노력이 미래의 가장 큰 자산이 됩니다.'
        },
        {
            name: '인간관계 확장의 해',
            icon: '🤝',
...
function calculateYearFortune() {
    ...
    const fortuneIndex = (year + month + day + 2025) % FORTUNE_DATA.fortunes.length;
    const fortune = FORTUNE_DATA.fortunes[fortuneIndex];
    const age = 2025 - year;
    
    // 결과 HTML 생성
    const resultHTML = `
        <div style="max-width: 600px; margin: 20px auto; padding: 20px; background: #f8f9fa; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            <div style="text-align: center; margin-bottom: 20px;">
                <h2 style="color: #2c3e50; margin-bottom: 10px;">${name ? name + '님의 ' : ''}2025년 을사년 운세</h2>
                <div style="font-size: 24px; margin: 10px 0;">${fortune.icon}</div>
                <h3 style="color: #e74c3c; margin: 10px 0;">${fortune.name}</h3>
                <p style="color: #7f8c8d; font-style: italic;">${fortune.summary}</p>
            </div>
            
            <div style="background: white; padding: 15px; border-radius: 8px; margin: 15px 0;">
                <h4 style="color: #3498db; margin-bottom: 10px;">💼 직장운</h4>
                <p style="line-height: 1.6; color: #2c3e50;">${fortune.career}</p>
            </div>
            
            <div style="background: white; padding: 15px; border-radius: 8px; margin: 15px 0;">
                <h4 style="color: #e91e63; margin-bottom: 10px;">💕 연애운</h4>
                <p style="line-height: 1.6; color: #2c3e50;">${fortune.love}</p>
            </div>
            
            <div style="background: white; padding: 15px; border-radius: 8px; margin: 15px 0;">
                <h4 style="color: #4caf50; margin-bottom: 10px;">💪 건강운</h4>
                <p style="line-height: 1.6; color: #2c3e50;">${fortune.health}</p>
            </div>
            
            <div style="background: white; padding: 15px; border-radius: 8px; margin: 15px 0;">
                <h4 style="color: #ff9800; margin-bottom: 10px;">💰 재물운</h4>
                <p style="line-height: 1.6; color: #2c3e50;">${fortune.money}</p>
            </div>
            
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 15px; border-radius: 8px; margin: 20px 0; color: white;">
                <h4 style="margin-bottom: 10px;">✨ ${age}세 맞춤 조언</h4>
                <p style="line-height: 1.6;">${fortune.advice}</p>
            </div>
            
            <div style="text-align: center; margin-top: 20px; padding: 15px; background: #ecf0f1; border-radius: 8px;">
                <p style="color: #7f8c8d; font-size: 14px; margin: 0;">
                    ${FORTUNE_DATA.yearInfo.description}
                </p>
            </div>
        </div>
    `;
