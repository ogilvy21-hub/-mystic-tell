    ...
    btnYear.onclick = function() {
        ...
        try {
            ...
            result.months.forEach(monthData => {
                html += `
                <div class="result-card" style="border-left: 4px solid ${levelColors[monthData.level]};">
                    <div class="card-header">
                        <div style="font-weight: bold; font-size: 1.1em; color: ${levelColors[monthData.level]};">${monthData.month}월</div>
                        <div class="card-title">${monthData.level}</div>
                    </div>
                    <div class="card-value">${monthData.score}점</div>
                    <div class="card-description" style="font-size: 0.85em;">${monthData.advice}</div>
                </div>`;
            });
